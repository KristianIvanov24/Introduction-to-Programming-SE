...
13. Напишете функция, която приема два сортирани масива и ги слива в трети масив като поддържа сортировката. За задачата НЕ може да използвате сортиращи алгоритми.
